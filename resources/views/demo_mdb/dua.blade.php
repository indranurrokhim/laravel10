...
@section('content')
    ...
    <div class="container text-center">
        ...
        <h1>MD Bootstrap JavaScript</h1>

        <p class="lead text-center pt-3">Visual guide to javascript plugins of the newest Bootstrap 4 and Material Design
        </p>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Date and Time Pickers</h3>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Alerts</h3>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Tooltips</h3>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Popovers</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-indigo" data-container="body" data-toggle="popover"
                        data-placement="left" data-title="Popover title"
        ...
        <!--Section: Dropdown and Select-->
        <section class="section">

            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Dropdown and Select</h3>

            <h5 class="pb-5">Dropdown</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown primary </button>
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown secondary </button>
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown default </button>
                ...
                <div class="col-md-4">
                    ...
                    <div class="dropdown">
                        ...
                        <!--Trigger-->
                        <button class="btn btn-mdb-color dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown mdb </button>
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown info </button>
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-warning dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown warning </button>
                ...
                <div class="col-md-4">
                    ...
                    <div class="dropdown">
                        ...
                        <!--Trigger-->
                        <button class="btn btn-unique dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown unique </button>

                        <!--Menu-->
                        <div class="dropdown-menu dropdown-unique">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown danger </button>
                    ...
                    <div class="dropdown">
                        ...
                        <!--Trigger-->
                        <button class="btn btn-elegant dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown elegant </button>

                        <!--Menu-->
                        <div class="dropdown-menu dropdown-elegant">
                            <a class="dropdown-item" href="#">Action</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                    ...
                    <div class="dropdown">
                        ...
                        <button class="btn btn-success dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown success </button>
            ...
            <div class="row text-left">
                ...
                <div class="col-lg-4 col-md-12 mb-4">
                    ...
                    <select class="mdb-select">
                        <option value="" disabled selected>Choose your option</option>
                        <option value="" data-icon="https://mdbootstrap.com/img/Photos/Avatars/avatar-1.jpg"
                            class="rounded-circle">example 1</option>
                        <option value="" data-icon="https://mdbootstrap.com/img/Photos/Avatars/avatar-2.jpg"
                            class="rounded-circle">example 2</option>
                        <option value="" data-icon="https://mdbootstrap.com/img/Photos/Avatars/avatar-3.jpg"
                            class="rounded-circle">example 1</option>
                    </select>
                    <label>Select with avatars</label>
            ...
            <h5 class="py-5">Color variations</h5>
            ...
            <div class="row text-left">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <!--Red select-->
                    <select class="mdb-select colorful-select dropdown-danger">
                        <option value="1">Option 1</option>
                        <option value="2">Option 2</option>
                        <option value="3">Option 3</option>
                        <option value="4">Option 4</option>
            ...
            <div class="row text-left">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <!--Blue select-->
                    <select class="mdb-select colorful-select dropdown-dark" searchable="Search here..">
                        <option value="1">Option 1</option>
                        <option value="2">Option 2</option>
                        <option value="3">Option 3</option>
                        <option value="4">Option 4</option>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Collapse</h3>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Modals</h3>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-center flex-wrap">
                                <button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal"
                                    data-target="#centralModalSuccess">Launch Modal</button>
                    ...
                    <div class="modal-dialog modal-notify modal-info" role="document">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="text-center">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt vero illo error
                                        eveniet
                                        cum.
                                    </p>
                                </div>
                            ...
                            <div class="modal-footer justify-content-center flex-wrap">
                                <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal"
                                    data-target="#fluidModalLeftInfoDemo">Launch Modal</button>
                                <a type="button" class="btn btn-outline-info waves-effect" data-dismiss="modal">No,
                                    thanks</a>
                            </div>
                        </div>
                        <!--/.Content-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-center flex-wrap">
                                <button type="button" class="btn btn-danger waves-effect waves-light" data-toggle="modal"
                                    data-target="#sideModalBRDangerDemo">Launch Modal</button>
                                <a type="button" class="btn btn-outline-danger waves-effect" data-dismiss="modal">No,
                                    thanks</a>
                            </div>
                        </div>
                        <!--/.Content-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-center flex-wrap">
                                <button type="button" class="btn btn-warning waves-effect waves-light" data-toggle="modal"
                                    data-target="#sideModalBLWarningDemo">Launch Modal</button>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">Lightbox</h3>
        ...
        <section class="section">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1">Carousels</h3>

            <h5 class="pb-5">Basic example</h5>
                    ...
                    <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="d-block img-fluid" src="https://mdbootstrap.com/img/Photos/Slides/1.jpg"
                                    alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid"
                                    src="https://mdbootstrap.com/img/Photos/Slides/img%20(141).jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid"
                                    src="https://mdbootstrap.com/img/Photos/Slides/img%20(145).jpg" alt="Third slide">
                            </div>
                        </div>
                        <!--Controls-->
                    ...
                    <div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="view">
                                    <img class="d-block w-100"
                                        src="https://mdbootstrap.com/img/Photos/Slides/img%20(6).jpg" alt="Second slide">
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="view">
                                    <img class="d-block w-100"
                                        src="https://mdbootstrap.com/img/Photos/Slides/img%20(9).jpg" alt="Third slide">
            ...
            <h5 class="pb-5">Thumbnails carousel</h5>
                ...
                <div class="col-md-12">
                    ...
                    <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="d-block img-fluid"
                                    src="https://mdbootstrap.com/img/Photos/Slides/img%20(88).jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid"
                                    src="https://mdbootstrap.com/img/Photos/Slides/img%20(121).jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block img-fluid"
                                    src="https://mdbootstrap.com/img/Photos/Slides/img%20(31).jpg" alt="Third slide">
                            </div>
                        </div>
                        <!--/.Slides-->
                        <!--Controls-->
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carousel-thumb" data-slide-to="0" class="active">
                                <img src="https://mdbootstrap.com/img/Photos/Others/Carousel-thumbs/img%20(88).jpg"
                                    class="img-fluid" alt="Material Design for Bootstrap - example thumbnail">
                            </li>
        ...
        <section class="section text-center">
            ...
            <!--Section heading-->
            <h3 class="section-heading h1 mt-0">SideNav</h3>
            ...
            <div class="documentation flex-center">
                <div class="gif-wrapper">
                    <img src="https://mdbootstrap.com/img/Photos/Others/sidenav3.gif"
                        alt="Material Design for Bootstrap - mobile" class="gif-content z-depth-0">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <h3 class="pt-4 mt-1 pb-3">White Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/white-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <h3 class="pt-4 mt-1 pb-3">Black Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/black-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/screens/skins/cyan.jpg"
                            alt="Material Design for Bootstrap cyan skin" class="img-fluid">

                        <div class="mask rgba-white-slight">
                        </div>
                    </div>

                    <h3 class="pt-4 mt-1 pb-3">Cyan Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/cyan-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>

                <div class="col-md-6 mb-4">
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/screens/skins/mdb.jpg"
                            alt="Material Design for Bootstrap mdb skin" class="img-fluid">

                        <div class="mask rgba-white-slight">
                        </div>
                    </div>

                    <h3 class="pt-4 mt-1 pb-3">MDB Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/mdb-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <h3 class="pt-4 mt-1 pb-3">Deep purple Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/deep-purple-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <h3 class="pt-4 mt-1 pb-3">Navy blue Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/navy-blue-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/screens/skins/pink.jpg"
                            alt="Material Design for Bootstrap pink skin" class="img-fluid">

                        <div class="mask rgba-white-slight">
                        </div>
                    </div>

                    <h3 class="pt-4 mt-1 pb-3">Pink Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/pink-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <h3 class="pt-4 mt-1 pb-3">Indigo Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/indigo-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <h3 class="pt-4 mt-1 pb-3">Light blue Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/light-blue-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>

                <div class="col-md-6 mb-4">
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/screens/skins/grey.jpg"
                            alt="Material Design for Bootstrap grey skin" class="img-fluid">

                        <div class="mask rgba-white-slight">
                        </div>
                    </div>

                    <h3 class="pt-4 mt-1 pb-3">Grey Skin</h3>
                    <a href="https://mdbootstrap.com/previews/docs/latest/html/skins/grey-skin.html"
                        class="btn btn-info mt-1">Live preview</a>
                </div>
        ...
        <!--Section: More-->
        <section class="section pb-5 text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <!--Featured image-->
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/Others/sections.jpg"
                            alt="Material Design for Bootstrap - sections" class="img-fluid">
                ...
                <div class="col-md-6 mb-4">
                    <!--Featured image-->
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/Others/templates.jpg"
                            alt="Material Design for Bootstrap - templates" class="img-fluid">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="view overlay z-depth-1-half">
                        ...
                        <a href="https://mdbootstrap.com/components/">
                            <div class="mask rgba-white-slight"></div>
                        </a>
                    </div>
                    ...
                    <a href="https://mdbootstrap.com/components/" class="btn btn-info">Live preview</a>
